...
public class Ch13Controller {
	...
	public String boardList(Model model, 
		...
		session.setAttribute("pager", pager); // model에 저장하면 request에 저장되기 때문에 응답완료 하면 기록이 삭제된다.
	...
	public void attachDownload(int bno, HttpServletResponse response) throws Exception {
		Ch13Board board = boardService.getBoardAttach(bno); // getBoardAttach: 첨부를 포함한 게시물 정보를 다 가져오는것
