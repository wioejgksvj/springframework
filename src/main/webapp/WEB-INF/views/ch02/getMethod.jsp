...
<%@ include file="/WEB-INF/views/common/top.jsp" %>
	...
	<div class="card">
		...
		<div class="card-body">			
			...
			<div class="mt-2">
				<form method="get" action="getFormTag"> <!-- action의 값은 요청의 경로 -->
				<hr/>
				<div class="mb-3">
					  <label for="bno" class="form-label">게시물 번호</label> <!-- for 안에 값은 id 값과 같아야 한다. -->
					  <input type="number" class="form-control" id="bno" name="bno" value="5"> <!-- 파라메타 이름을 name속성에 준다. -->
					</div>
